...
nnoremap <C-j> <Cmd>call VSCodeNotify('indentation-level-movement.moveDown')<CR>
nnoremap <C-k> <Cmd>call VSCodeNotify('indentation-level-movement.moveUp')<CR>
nnoremap <C-l> <Cmd>call VSCodeNotify('indentation-level-movement.moveRight')<CR>
